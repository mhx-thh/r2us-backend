...
exports.signup = catchAsync(async (request, response) => {
  ...
  createAndSendToken(newUser, StatusCodes.CREATED, response);
});
...
exports.login = catchAsync(async (request, response, next) => {
  ...
  if (!user || !(await user.comparePassword(password, user.password))) return next(new AppError('Incorect Email or Password', StatusCodes.UNAUTHORIZED));
